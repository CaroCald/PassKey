...
struct RegistrationCredential: Encodable {
    ...
    init(registration: ASAuthorizationPlatformPublicKeyCredentialRegistration) {
        id = base64ToBase64URL(input:registration.credentialID.base64EncodedString())
    ...
    struct Response: Encodable {
        ...
        init(registration: ASAuthorizationPlatformPublicKeyCredentialRegistration) {
            attestationObject = base64ToBase64URL(input:registration.rawAttestationObject!.base64EncodedString())
            clientDataJSON = base64ToBase64URL(input:registration.rawClientDataJSON.base64EncodedString())
        }
    }
}
...
struct AssertionCredential: Encodable {
    ...
    init(assertion: ASAuthorizationPlatformPublicKeyCredentialAssertion) {
        id = base64ToBase64URL(input:assertion.credentialID.base64EncodedString())
    ...
    struct Response: Encodable {
        ...
        init(assertion: ASAuthorizationPlatformPublicKeyCredentialAssertion) {
            ...
            authenticatorData = base64ToBase64URL(input: assertion.rawAuthenticatorData.base64EncodedString())
            clientDataJSON = base64ToBase64URL(input: assertion.rawClientDataJSON.base64EncodedString())
            signature = base64ToBase64URL(input:assertion.signature.base64EncodedString())
            userHandle = base64ToBase64URL(input:assertion.userID.base64EncodedString())
